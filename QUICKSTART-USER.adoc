...
// Replace verisimdb-data, Verisimdb Data — See README.adoc for details., just run, Verisimdb Data started successfully. with actuals
= verisimdb-data — Quick Start for Users
:toc:
:toclevels: 2

== What is verisimdb-data?

Verisimdb Data — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./verisimdb-data-portable
----
...
[source]
----
Verisimdb Data started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/verisimdb-data/wiki
