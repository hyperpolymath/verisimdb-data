...
doctor:
    @echo "Running diagnostics for verisimdb-data..."
...
help-me:
    @echo "=== verisimdb-data Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/verisimdb-data/issues/new"
    @echo ""
